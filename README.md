...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/crimson-sun-26e1)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/crimson-sun-26e1
```

A live public deployment of this template is available at [https://crimson-sun-26e1.templates.workers.dev](https://crimson-sun-26e1.templates.workers.dev)
